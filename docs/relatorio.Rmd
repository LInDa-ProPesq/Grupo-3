...
\newpage
###Sexo
Uma vez que a maioria dos respondentes eram do curso de Ciência da Computação ou de Sistemas de Informaçãod a Unesp de Bauru, é normal observar um número maior de homens, como mostra o gráfico abaixo:
